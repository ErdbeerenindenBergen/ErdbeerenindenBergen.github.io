...
const About = () => {
  ...
  const slides = [
    ...
    title: "teaching", text: "During my almost decade-long teaching career, I delivered over $4.1M in instructional services to 1700+ students and received an evaluation rating of 4.9 out of 5 across 47 courses with 3 different universities.", 
    ...
    title: "EU-Nato trip", 
    text: "In 2019, I was selected alongside a NY Times journalist as one of only 2 nominees in Germany by the German and Belgian Fulbright Commissions to travel to Luxembourg and Belgium for week-long seminar at the EU and NATO headquarters; discussed government responses to cyberterrorism", 
    subtitle: "place holder" }
